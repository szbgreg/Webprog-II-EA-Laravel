    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="card shadow-sm mt-4 mb-5 bg-light">
                <div class="card-body">
                    <h4 class="h3 card-title mb-4 text-primary mx-auto">Süti szerkesztése</h4>

                    <form method="post" action="{{ route('sutik.update', $suti->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <input type="text" id="nev" name="nev"
                                ...
                                value="@if(!empty($suti)){{ $suti->nev }}@endif"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="tipus" name="tipus"
                                ...
                                value="@if(!empty($suti)){{ $suti->tipus }}@endif"
                        ...
                        <div class="mb-3">
                            ...
                            <select id="dijazott" name="dijazott"
                                class="form-select">
                                <option value="0" @if(!empty($suti)){{ $suti->dijazott == '0' ? 'selected' : '' }}@endif>Nem</option>
                                <option value="1" @if(!empty($suti)){{ $suti->dijazott == '1' ? 'selected' : '' }}@endif>Igen</option>
                            </select>
                        </div>
                        <div class="d-flex justify-content-end gap-1 ">
                            <div>
                                <a href="{{route('sutik.index')}}" class="btn btn-outline-secondary">Vissza a listához</a>
                            </div>
